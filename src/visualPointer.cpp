...
VisualPointer::VisualPointer(bool isAbovePointer, SDL_Rect name_rect, SDL_Rect arrow_rect, 
                            ...
                            std::string name, SDL_Texture* name_texture_ptr, int index)
{
...
bool VisualPointer::slidePointer(int _index, Configuration config, VisualArray* visualArray_ptr)
{
    ...
    int goal_x = initial_x + distanceToIndex * DOUBLE_DIGIT_WIDTH*2;
